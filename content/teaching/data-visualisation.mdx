...
<a href="https://summerschool.tlu.ee/data-visualisation-with-python-and-ai/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm transition-colors duration-200 no-underline mb-6 mt-2">
...
<a href="https://summerschool.tlu.ee/data-visualisation-with-python-and-ai/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm transition-colors duration-200 no-underline mt-6">
  Enroll in this course →
</a>

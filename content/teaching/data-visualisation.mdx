...
<a href="https://summerschool.tlu.ee/data-visualisation-with-python-and-ai/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm bg-accent text-black font-medium hover:opacity-90 transition-default no-underline">
